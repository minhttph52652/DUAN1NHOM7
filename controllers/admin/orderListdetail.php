...
$result = $orderDetails->getOrderDetails($_GET['orderId']);// hiển trị chi tiết đơn hàng theo orderId
$order = new order();
$order_result = $order->getById($result[0]['orderId']);// lấy thông tin đơn hàng theo orderId

include_once __DIR__ . '/../../models/user.php';
$totalPrice = $orderDetails->getTotalPriceByUserId($_GET['orderId']);// Tính tổng tiền và số lượng
$totalQty = $orderDetails->getTotalQtyByUserId($_GET['orderId']);// Cập nhật trạng thái đơn hàng -> 'đã giao'
$user = new user();
$userInfo = $user->getUserByOrder($_GET['orderId']);// Lấy thông tin người dùng theo orderId
